    ...
    <div class="col-md-3">
      ...
      <div class="box box-primary">
        <div class="box-body box-profile">
          <img src="/admin_l_t_e/img/user4-128x128.jpg" class="profile-user-img img-responsive img-circle" alt="User profile picture">
          <h3 class="profile-username text-center">
            <?php echo $persona['nombre'] . ' ' . $persona['apellido1']. ' ' . $persona['apellido2']
            ?>
          </h3>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Sobre el Alumno</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <strong><i class="fa fa-book margin-r-5"></i> Especialidades</strong>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="box box-primary">
                    ...
                    <?= $this->Form->create($persona, array('role' => 'form','class'=>'form-horizontal')) ?>
                    <div class="box-body">
                      <?php
                      echo $this->Form->input('fechareg');
