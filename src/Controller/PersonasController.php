...
class PersonasController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Addresses', 'TypeDocuments']
        ];
    ...
    public function view($id = null)
    {
        $persona = $this->Personas->get($id, [
            'contain' => ['Addresses', 'TypeDocuments', 'Teachers']
        ]);
    ...
    public function add()
    {
        ...
        $addresses = $this->Personas->Addresses->find('list', ['limit' => 200]);
        $typeDocuments = $this->Personas->TypeDocuments->find('list', ['limit' => 200]);
        $this->set(compact('persona', 'addresses', 'typeDocuments'));
        $this->set('_serialize', ['persona']);
    }
