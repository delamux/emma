        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="hidden-xs"><?php echo //Insertamos el nombre del usuario
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="user-header">
                        ...
                        <p>
                            <?php echo //Insertamos el nombre del usuario
                                $current_user['first_name'] . ' ' . $current_user['last_name'] . ' - '. $current_user['role']
                            ?>
                    ...
                    <li class="user-footer">
                        <div class="pull-left">
                            ...
                            $this->Html->link(
                                __('Perfil'),
                                ['controller' => 'Users/users', 'action' => 'profile' ],
                                [
                        ...
                        <div class="pull-right">
                                ...
                                $this->Html->link(
                                    __('Salir'),
                                    ['controller' => 'Users/users', 'action' => 'logout' ],
                                    [
                                        'class' => 'btn btn-default btn-flat'
                                    ])
