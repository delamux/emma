...
class AcademicYearsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'fecha_ini' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'fecha_ini' => '2016-11-22',
            'fecha_fin' => '2016-11-22',
            'active' => 1,
            'created' => '2016-11-22 17:31:44',
            'modified' => '2016-11-22 17:31:44'
        ],
    ];
}
